...
class BisectionTest(unittest.TestCase):
    ...
    def test_split_by_clusters(self):
        ...
        lista, listb = bisections.optimize_split_by_rclust(alist, clusters, 50)
