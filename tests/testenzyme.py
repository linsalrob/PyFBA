...
class TestEnzyme(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.enz = Enzyme('test enz')
        self.enz.roles = {'a', 'b', 'c'}

    def test_equals(self):
        """Does the equals function work"""
        otherenz = Enzyme('test enz')
        otherenz.roles = {'a', 'b', 'c'}
        self.assertEquals(self.enz, otherenz)
    ...
    def test_hash(self):
        ...
        h = hash('test enz')
        self.assertEquals(h, hash(self.enz))
    ...
    def test_add_roles(self):
        ...
        self.enz.add_roles({'m', 'n', 'o'})
        self.assertEquals(len(self.enz.roles), 6)
    ...
    def test_number_of_roles(self):
        ...
        self.assertEquals(self.enz.number_of_roles(), 3)
    ...
    def test_number_of_pegs(self):
        ...
        self.assertEquals(self.enz.number_of_pegs(), 0)
        self.enz.add_pegs({'p1':'a', 'p2':'b', 'p3' : 'c'})
        self.assertEquals(self.enz.number_of_pegs(), 3)
    ...
    def test_add_reaction(self):
        ...
        self.assertEquals(len(self.enz.reactions), 1)
        # check this is a set
        self.enz.add_reaction('a reaction')
        self.assertEquals(len(self.enz.reactions), 1)
    ...
    def test_number_of_reactions(self):
        ...
        self.enz.add_reaction('a reaction')
        self.assertEquals(self.enz.number_of_reactions(), 1)
        self.enz.add_reaction("Another reaction")
        self.assertEquals(self.enz.number_of_reactions(), 2)
    
    def test_probability(self):
        """Test that we get a probability back"""
        self.enz.add_a_peg('123', 'a')
        self.assertEquals(self.enz.probability(), (1.0 * 1/3))
