...
class SuggestionTest(unittest.TestCase):
    ...
    def test_without_proteins(self):
        ...
        self.assertGreaterEqual(len(suggested), 27678)
    ...
    def test_media(self):
        ...
        self.assertGreaterEqual(len(suggested), 13)
    ...
    def test_probability(self):
        ...
        self.assertEqual(len(suggested), 1914)
    ...
    def test_subsystems(self):
        ...
        self.assertEqual(len(suggestions), 42)
