...
class SuggestionTest(unittest.TestCase):
    ...
    def test_essential(self):
        suggested = PyFBA.gapfill.essentials.suggest_essential_reactions()
    ...
    def test_roles_from_file(self):
        ...
        suggs = PyFBA.gapfill.suggest_from_roles(os.path.join(test_file_loc, 'roles.txt'), self.__class__.reactions, 0.9)
